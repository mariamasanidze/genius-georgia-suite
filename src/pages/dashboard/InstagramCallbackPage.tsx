        ...
        const linkAccount = async () => {
            try {
                ...
                if (error) {
                    ...
                    toast.error(errorDescription || "Failed to connect Instagram account");
                    setStatus("error");
                ...
                console.log("Linking Instagram account with code:", code);
                ...
                toast.success("Instagram account successfully linked!");
                setStatus("success");
        ...
        <div className="flex flex-col items-center justify-center h-screen bg-gray-900 text-white gap-4">
            {status === "loading" && (
                <>
                    ...
                    <p className="text-lg">Connecting your Instagram account...</p>
